  ...
  return (
    <section className="relative pt-28 sm:pt-36 lg:pt-44 pb-16 sm:pb-24 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 sm:mb-12">
        <div className="inline-flex flex-wrap items-center gap-x-4 gap-y-2 py-2 px-3 sm:px-4 bg-[#FAFAFB] brutalist-border font-mono text-[11px] sm:text-xs font-semibold uppercase tracking-widest text-[#2B2B33]">
        ...
        <div className="max-w-6xl">
          ...
          >
            ...
            <span className="relative inline-block">
              TOLERANCE.
              {/* Solid orange accent block underline on "TOLERANCE." matching Professional Polish */}
          ...
          <div className="mt-8 sm:mt-12 pt-8 sm:pt-10 border-t border-[#2B2B33] grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div className="lg:col-span-7">
              <p className="font-sans text-base sm:text-lg lg:text-xl font-medium leading-relaxed text-[#2B2B33] opacity-90 max-w-2xl">
                We deliver mirror-smooth internal skimming, weather-resistant monocouche rendering, and heritage lath &amp; plaster conservation for residential homes, period estates, and commercial developments. <strong className="font-bold text-[#2B2B33] underline decoration-[#F5821F] decoration-2 underline-offset-4">No shortcuts. Zero snags. Built for architectural longevity.</strong>
              </p>
              ...
              <div className="mt-8 sm:mt-10 flex flex-wrap items-center gap-4 sm:gap-6">
                ...
                >
                  <span>REQUEST WRITTEN SPECIFICATION</span>
                ...
                >
                  <span>EXPLORE [01–06] SERVICES</span>
            ...
            <div className="lg:col-span-5 bg-[#FAFAFB] border border-[#2B2B33] p-6 sm:p-8 space-y-5">
              <div className="font-mono text-[11px] uppercase tracking-widest text-[#6B6B78] pb-3 brutalist-border-b border-[#E8E8EE] flex items-center justify-between">
                <span>TECHNICAL TOLERANCES</span>
                <span className="text-[#F5821F] font-bold">[BS 5262]</span>
              </div>

              <ul className="space-y-3 font-mono text-xs sm:text-sm text-[#2B2B33]">
                <li className="flex items-start gap-2.5">
                  <CheckCircle2 className="w-4 h-4 text-[#F5821F] shrink-0 mt-0.5" />
                  <span><strong>&lt; 1.5mm Deviation:</strong> Laser-checked over 3m straight edge for glass-flat skims.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <Shield className="w-4 h-4 text-[#F5821F] shrink-0 mt-0.5" />
                  <span><strong>10-Year Guarantee:</strong> On structural monocouche &amp; external silicone renders.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <Award className="w-4 h-4 text-[#F5821F] shrink-0 mt-0.5" />
                  <span><strong>£10M Public Liability:</strong> Fully insured for high-value residential &amp; heritage sites.</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="mt-16 sm:mt-24 border-y border-[#2B2B33] bg-[#FAFAFB] py-3.5 px-4 sm:px-6 lg:px-8 overflow-hidden select-none">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-6">
          <div className="flex items-center gap-2 font-mono text-xs font-extrabold uppercase tracking-widest text-[#2B2B33] shrink-0">
            <MapPin className="w-4 h-4 text-[#F5821F]" />
            <span>PRIMARY ESSEX SERVICE ROUTE //</span>
          </div>

          <div className="flex items-center gap-4 overflow-x-auto no-scrollbar font-mono text-xs font-semibold text-[#2B2B33] tracking-widest whitespace-nowrap">
